...
import { ProductSearchCombobox } from "@/components/features/stock-in/product-search-combobox";
...
interface StockOutItemsEditorProps {
  ...
  onChange: (items: StockOutItemDraft[]) => void;
  currency: string;
  readOnly?: boolean;
}
...
export function StockOutItemsEditor({
  ...
  function handleAddProduct(product: Product) {
    ...
    const newItem: StockOutItemDraft = {
